...
class ClozeDeletionWidget extends StatefulWidget {
  ...
  @override
  State<ClozeDeletionWidget> createState() => _ClozeDeletionWidgetState();
}

class _ClozeDeletionWidgetState extends State<ClozeDeletionWidget> {
