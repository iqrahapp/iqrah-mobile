...
class TajweedMapper:
    ...
    def map_phoneme_to_tajweed(
        ...
        Uses the word's Tajweed data and phoneme timing to determine which rule applies.
        """
        ...
        # Find which Tajweed segment this phoneme overlaps with most
        # Assume segments are distributed proportionally across the word duration
        ...
        # Default: return category of segment with most overlap
        return tajweed_segments[0]['category'] if tajweed_segments else None
