...
_$SyncPullCursorImpl _$$SyncPullCursorImplFromJson(Map<String, dynamic> json) =>
    _$SyncPullCursorImpl(
      settings: json['settings'] == null
          ? null
          : SyncCursorSetting.fromJson(
...
_$SyncChangesImpl _$$SyncChangesImplFromJson(Map<String, dynamic> json) =>
    _$SyncChangesImpl(
      settings: (json['settings'] as List<dynamic>?)
              ?.map((e) => SettingChange.fromJson(e as Map<String, dynamic>))
              .toList() ??
          const [],
      memoryStates: (json['memory_states'] as List<dynamic>?)
              ?.map(
                  (e) => MemoryStateChange.fromJson(e as Map<String, dynamic>))
              .toList() ??
          const [],
      sessions: (json['sessions'] as List<dynamic>?)
              ...
              .toList() ??
          const [],
      sessionItems: (json['session_items'] as List<dynamic>?)
              ?.map(
                  (e) => SessionItemChange.fromJson(e as Map<String, dynamic>))
              .toList() ??
          const [],
    );
