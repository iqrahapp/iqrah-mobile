...
class MissingWordMcqWidget extends StatefulWidget {
  final String nodeId;
  ...
  @override
  State<MissingWordMcqWidget> createState() => _MissingWordMcqWidgetState();
}

class _MissingWordMcqWidgetState extends State<MissingWordMcqWidget> {
  ...
  Future<void> _loadContent() async {
    ...
    try {
      ...
      for (final word in words) {
        if (word.position == widget.blankPosition) {
          buffer.write('_____ ');
      ...
      children: [
        ...
        ..._options.asMap().entries.map((entry) {
          return Padding(
            ...
            child: Semantics(
              button: true,
              label: 'Select word option ${entry.key + 1}',
