...
# Try to import SwiftF0, fallback to CREPE if not available
try:
    from swift_f0 import SwiftF0
    SWIFT_F0_AVAILABLE = True
except ImportError:
    SWIFT_F0_AVAILABLE = False
    print("Warning: swift-f0 not installed. Falling back to CREPE for pitch extraction.")
    print("Install with: pip install swift-f0")
...
def _get_detector():
    ...
    if not SWIFT_F0_AVAILABLE:
        raise ImportError("swift-f0 not installed. Use extract_pitch_crepe_fast() instead.")
